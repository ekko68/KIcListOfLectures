...
public class UserDaoImpl extends JdbcDaoSupport implements UserDao{
	...
	private static final String INSERT = "INSERT INTO USERTB(USERID, USERNAME, PASSWORD, POSTCODE, ADDRESS, EMAIL, JOB, BIRTHDAY) VALUES(?, ?, ?, ?, ?, ?, ?, ?)";
	...
	public User findByUserIdAndPassword(String userId, String password) {
		return (User)getJdbcTemplate().query(SELECT_BY_USERID_PASSWORD, 
				 new UserPreparedStatementSetterForFind(userId, password), 
