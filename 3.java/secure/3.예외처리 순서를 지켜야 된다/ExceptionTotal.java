...
public class ExceptionTotal {
	public static void main(String[] args) {
		...
		try {
			 ...
			 * catch(Exception e) {//위에 언급한 예외처리클래스 외의 예외는 Exception //이 처리해줄 수 있다.(자동
			 * 객체형변환) System.out.println(e);//e.toString() System.out.println
			 * ("위에서 발생한 예외처리 외의 다른 예외처리를 처리해줄 수 있다"); }
			 */
	}
}
