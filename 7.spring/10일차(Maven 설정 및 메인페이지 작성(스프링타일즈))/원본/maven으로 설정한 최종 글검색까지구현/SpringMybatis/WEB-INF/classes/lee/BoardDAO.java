...
public interface BoardDAO{
	...
	public void updatecnt(String num)
	                                  throws DataAccessException;
	//5.글상세보기
	public BoardCommand retrieve(String num)
	                                  throws DataAccessException;
	//6.글수정하기
	...
	//8.글검색하기->search()
	//public List search(String searchName,String searchValue)~
	//public List search(HashMap map)~=>Map객체를 이용->전달
	public List search(BoardCommand board)
			                  throws DataAccessException;
