...
package com.board.util;//유틸리티에 관련된 패키지

//페이징 처리만 따로 계산해서 처리해주는 유틸리티 클래스
...
public class PagingUtil {
	...
	/**
	 * currentPage : 현재페이지
	 * totalCount : 전체 게시물 수->레코드갯수
	 * blockCount : 한 페이지의  게시물의 수(=numPerPage)
	 * blockPage : 한 화면에 보여줄 페이지 수(pagePerBlock)
	 * pageUrl : 호출 페이지 url (=>링크해서 이동할 url)
	 * ex) http://www.jspstudy.co.kr/main/main.jsp?PATH=/board/boardList.jsp?b_division1=free
	...
	public int getStartCount() {
		return startCount;   //<%=객체명.get메서드()%>  ${멤버변수명}
	}
