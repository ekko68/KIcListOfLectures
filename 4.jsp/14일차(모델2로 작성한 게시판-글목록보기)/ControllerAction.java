...
public class ControllerAction extends HttpServlet {
    ...
    //명령어와 명령어 처리클래스를 쌍으로 저장(실질적으로 처리해주는 객체저장)
  ...
  //경로에 맞는 CommandPro.properties파일을 불러옴
    ...
    System.out.println("불러온경로="+props);//경로 포함해서 파일명
  ...
  //Properties객체 생성
    ...
    FileInputStream f = null;//파일불러올때 
     ...
     //객체에 저장된 객체를 접근(properties->클래스명->문자열이기때문에)
     ...
     while(keyiter.hasNext()){
       ...
       //클래스가 생성->클래스명.newInstance()호출->객체생성
       Object commandInstance = commandClass.newInstance();
       System.out.println
              ("commandInstance="+commandInstance);
      
       //Map객체 commandMap에 저장(/list.do,ListAction@주소값)
